...
class TestJoinPageWithParameter:
    ...
    def perform_test_steps(self, driver):
        ...
        driver.find_element("tag name", "body").screenshot('user/Reports/html/screenshot/onload_screenshot.png')
        ...
        driver.find_element("tag name", "body").screenshot('user/Reports/html/screenshot/application_page.png')
