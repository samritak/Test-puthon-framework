...
class TestDifferentWidthsWithScroll:
    ...
    def perform_test_steps(self, url):
        ...
        for index in width:
            ...
            try:
                ...
                driver.find_element("tag name", "body").screenshot('Reports/html/screenshot/page_width_' + str(index) + '_load_screenshot_.png')
                time.sleep(3)
                ...
                driver.set_window_size(self.full_page_screenshot_lp('Width'),
                                    self.full_page_screenshot_lp('Height'))
                driver.find_element("tag name", "body").screenshot('Reports/html/screenshot/page_width_' + str(index) + '_scroll_screenshot_.png')
                time.sleep(3)
