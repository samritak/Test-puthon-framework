...
class PypRenewPage(TemplateClass):
    #Button_Click_Hero_Renew = (By.XPATH, '/html/body/div[1]/main/div/div[2]/div[1]/div[1]/div/div[2]/div/p[2]/a')
    #Select_Premium1 = (By.XPATH, '/html/body/div[1]/main/div/div[2]/div[1]/div[1]/div/div[1]/div/div[1]/a')
    #Select_Premium2 = (By.XPATH, '/html/body/div[1]/main/div/div[2]/div[1]/div[1]/div/div[1]/div/div[2]/a')
    Button_Click_Hero_Renew = (By.CLASS_NAME, 'renew')
    Select_Premium1 = (By.CLASS_NAME, 'dynPremium1')
    Select_Premium2 = (By.CLASS_NAME, 'dynPremium2')
    """
    ...
    def query_string_present(self, url):
        ...
        assert query_string_present == False, "Query string should not present in the given input URL \n"
    ...
    def compare_all_qs_params_in_json_for_pyp(self, landing_page_qs_params, application_page_qs_params):
        self.compare_query_string_parameters_for_pyp(landing_page_qs_params, application_page_qs_params)
