...
class TestMemCopyTextVerification:
    ...
    def perform_test_steps(self, url):
        ...
        for index in width:
            ...
            try:
                ...
                time.sleep(3)
                if driver.find_elements(By.XPATH, "//div[contains(@class,'cmp-experiencefragment--Header_Experience_Fragment')]"):
                    ...
                    print("Membership nav bar is not present in the landing page " + url)
                    """ email sending  """
                    subject = 'ALERT! Test Case Failed for MEM nav bar'
                    body = " Membership nav bar is not present in the landing page " + url
