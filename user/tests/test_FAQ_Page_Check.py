            ...
            try:
                ...
                if link_exists1:
                    for i in link_exists1:
                        ...
                        if href_link == "tel:1-888-687-2277" or href_link == "tel:+1-888-687-2277" or href_link == "tel:1-866-804-1278" or href_link == "tel:+1-866-804-1278" or href_link == "tel:1-866-684-9291" or href_link == "tel:+1-866-684-9291" :
            ...
            for ca_link in can_links:
                ...
                if rel == "canonical":
                    ...
                    if ca_link.get_attribute("href").endswith('/'):
                        if url.strip()=='https://www.aarp.org/membership/faqs/can-i-gift-an-aarp-membership2/':
                            print(f" link : {ca_link.get_attribute('href')} is valid canonical tag")
                            continue
                        if ca_link.get_attribute("href").strip()==url.strip():
                            ...
                            if ca_link.get_attribute("href").rstrip("/") == strip:
                                ...
                                error_count += 1
                                print(f" link : {ca_link.get_attribute('href')} is invalid canonical tag")
                        else:
                            error_count+=1
                    else:
                        error_count+=1
