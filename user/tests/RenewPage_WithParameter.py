...
class RenewPage(TemplateClass):
    ...
    def click_renew_button(self):
        is_visible = self.is_visible(self.Button_Click_Header_Renew)
        assert is_visible == True, "The Button is not visible"
        print("Clicked on RENEW header button")
        self.button_click(self.Button_Click_Header_Renew)
    ...
    def compare_all_qs_params_in_json(self, experience_name, application_url, landing_page_qs_params,
        ...
        self.compare_query_string_parameters('renew', experience_name, application_url, landing_page_qs_params,
                                             application_page_qs_params, landing_page_url)
