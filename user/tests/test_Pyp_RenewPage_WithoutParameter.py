...
from PypRenewPage_WithoutParameter import PypRenewPage
from user.Config.config import Global_Env_Data
import csv


class TestPypRenewPageWithoutParameter(BaseTemplate):
    def test_renew(self):
        self.contents = []
        path_to_file = Global_Env_Data.LOCAL_PATH + Global_Env_Data.TEMPLATE_PYP_WITHOUT_PARAMETER
    ...
    def perform_test_steps_premium1(self):
        ...
        self.renew_page.compare_qs_values("campaignid", self._default_rkc1,
                                         self._campaign_id)
    ...
    def perform_test_steps_premium2(self):
        ...
        self.renew_page.compare_qs_values("campaignid", self._default_rkc2,
                                         self._campaign_id)
